...
* Sandbox
    ...
    1.  1 Create your partner's account (https://uat.e-mpata.snedac.com/signin) to obtain your test credentials
    1.  2 Contact us via e-mail address **christopher.osei@hologram.cd** to obtain your Sandbox API key

* Live

    1.  1 Create your partner's account (https://empata.snedac.com/signin) to obtain your Live credentials
